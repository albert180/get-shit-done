...
**A light-weight and powerful meta-prompting, context engineering and spec-driven development system for Claude Code, OpenCode, Gemini CLI, Codex, and Mistral Vibe.**
...
1. **Runtime** — Claude Code, OpenCode, Gemini, Codex, Mistral Vibe, or all
...
- OpenCode: `/gsd-help`
- Codex: `$gsd-help`
- Mistral Vibe: `/gsd-help`

> [!NOTE]
> Codex and Mistral Vibe installations use skills (`skills/gsd-*/SKILL.md`) rather than custom prompts.
...
Use `--claude`, `--opencode`, `--gemini`, `--codex`, `--mistral`, or `--all` to skip the runtime prompt.
...
npx get-shit-done-cc --mistral --global --uninstall

# Local installs (current project)
npx get-shit-done-cc --claude --local --uninstall
npx get-shit-done-cc --opencode --local --uninstall
npx get-shit-done-cc --codex --local --uninstall
npx get-shit-done-cc --mistral --local --uninstall
```
...
OpenCode, Gemini CLI, Codex, and Mistral Vibe are now natively supported via `npx get-shit-done-cc`.
